...
The plugin helps you accept payments using MoneyGram Transfers.
...
1. Upload 'woocommerce-money-gram-gateway' to the '/wp-content/plugins/' directory
2. Activate the plugin through the 'Plugins' menu in WordPress
3. Access 'admin.php?page=mg-settings&tab=checkout&section=wunion' in order to change the description and the details provided in the email
